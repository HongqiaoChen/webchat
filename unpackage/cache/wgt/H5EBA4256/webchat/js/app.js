...
window.app = {
	 ...
	 * netty服务后端发布的url地址
	 */
	nettyServerUrl: "ws://hongqiaochen.top:8988/ws",
	
	/**
	 * 后端服务发布的url地址
	 */
	serverUrl: "http://hongqiaochen.top:8788/chat",
	
	/**
	 * 图片服务器的url地址
	 */
	imgServerUrl: 'http://hongqiaochen.top:8888/',
	...
	getFriendFromContactList:function(friendId){
		...
		if(this.isNotNull(contactListStr)){
			...
			for(var i = 0;i<contactList.length;i++){
				...
				if(friend.myFriendsId == friendId){
					return friend;
					break;
				}
			}
